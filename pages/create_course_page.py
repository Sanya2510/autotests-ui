...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_description_textarea = (
            ...
            page.get_by_test_id('create-course-form-description-input').locator('textaria').first
        )
    ...
    # Методы для работы с заголовками и кнопкой создания курса
    ...
    def check_visible_create_course_form(self, title, estimated_time, description, max_score, min_score):
    ...
    # Метроды для работы с упражнениями
